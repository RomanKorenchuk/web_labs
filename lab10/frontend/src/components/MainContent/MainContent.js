...
import { bankApi, loanApi } from '../../api/apiService';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setFeaturedBanks(banksResponse.data);
        setFeaturedProducts(loansResponse.data);
      } catch (error) {
    ...
    return (
      <main className="main-content">
        <div className="container">
          <Spinner text="Завантаження даних..." />
        </div>
      </main>
    );
  }
            ...
            {featuredBanks.map(bank => (
              <div key={bank.id} className="bank-card">
                ...
                <div className="bank-info">
                  ...
                  <Link to={`/bank/${bank.id}`} className="bank-button">Детальніше</Link>
                </div>
              </div>
            ))}
          </div>
            ...
            {featuredProducts.map(product => (
              <div key={product.id} className="product-card">
                ...
                <div className="product-content">
                  ...
                  <Link to={`/loan/${product.id}`} className="product-button">Оформити</Link>
                </div>
              </div>
            ))}
          </div>
